					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="${ctx}/images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
								...
								<li><a href="${ctx}/showcart/show">查看购物车</a></li>								
								<div class="clear"></div>
							</ul>
			...
			<br>
				...
				<div class="col-md-3 shop_box"><a href="product?id=${p.id }">
					...
					<div class="shop_desc">
						...
						<ul class="buttons">
							<li class="cart">
							<c:if test="${user.id eq null}"><a href="#" onclick="onlogin()">加入购物车</a></c:if>
							<c:if test="${!(user.id eq null)}"><a href="${ctx}/cart/cartadd?productId=${p.id }">加入购物车</a></c:if>
							</li>
							<li class="shop_btn"><a href="product?id=${p.id }">了解更多</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div> 
				</a></div>
