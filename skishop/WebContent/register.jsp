...
function checkName(){
	$.post("registuser/checkname",{un:$("#username").val()},function(result){
		if(result!="null"){
		alert(result);
		}
	}) ;
		...
		function equalvalidate(){
			...
			if(pwd1 != pwd2){
				document.getElementById("equalvalid").innerHTML="<font color='red'>两次密码不相同</font>";
				document.getElementById("submit").disabled = true;
			}else{
				document.getElementById("equalvalid").innerHTML=""
		...
		function lengthvalidate(){
			...
			var pwd2 = document.getElementById("pwd2").value;
			if(pwd1.length<6){
				document.getElementById("lengthvalid").innerHTML="<font color='red'>密码长度应大于6</font>"
				document.getElementById("submit").disabled = true;
			}else{
				document.getElementById("lengthvalid").innerHTML=""
					document.getElementById("submit").disabled = false;
				}
		}
...
<body>
	<div class="header">
     ...
     <div class="main">
      <div class="shop_top">
	     <div class="container">
						<form action="registuser/regist" method = "post"> 
								...
								<div class="register-bottom-grid">
										...
										<div>
											...
											<input type="text" name = "password" id = "pwd1" onblur="lengthvalidate()"/><span id ="lengthvalid"></span>
										</div>
										<div>
											<span>确认密码<label>*</label></span>
											<input type="text" name = "repassword" id ="pwd2" onblur="equalvalidate()"/><span id ="equalvalid"></span>
										</div>
										<div class="clear"> </div>
								</div>
								<div class="clear"> </div>
