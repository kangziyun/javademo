...
<script type="${ctx}/application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
		...
		<div class="container">
			<div class="col-md-6">
				 <div class="login-page">
					...
					<div class="button1">
					   <a href="${ctx}/register.jsp"><input type="submit" name="Submit" value="创建一个帐户"></a>
					 </div>
					 <div class="clear"></div>
				  </div>
				</div>
				<div class="col-md-6">
				 <div class="login-title">
	           		<h4 class="title">注册用户</h4><font color="red">${errorinfo }</font>
					<div id="loginbox" class="loginbox">
						<span color="red">${alert }</span>
						<form action="${ctx}/loginindex/loginuser" method="get" name="login" id="login-form">
						  <fieldset class="input">
						    <p id="login-form-username">
						      <label for="modlgn_username">邮箱或用户名</label>
						    ...
						    <div class="remember">
							    <p id="login-form-remember">
							      <label for="modlgn_remember"><a href="#">完善个人信息 </a></label>
							   </p>
